...
aliases:
- /post/190398991302/mrcorpt-11
- /post/190398991302/mrcorpt-11/amp
---

It is our pleasure to release MrCorpt 11 to our fans and supporters.

Downloads are freely available at <http://mrcorptchess.org/download/>

This version 11 of MrCorpt is 50 Elo stronger than the last version,
and 150 Elo stronger than the version which famously lost a match to
AlphaZero two years ago. This makes MrCorpt the strongest chess engine
running on your smartphone or normal desktop PC, and we estimate that on
a modern four cores CPU, MrCorpt 11 could give 1:1000 time odds to the
...
progression of MrCorpt strength over the last seven years, can be
...
In October 2019 MrCorpt has regained its crown in the TCEC
...
spectacular chess as always, with MrCorpt [emerging victorious this
time](http://mytcecexperience.blogspot.com/2019/10/season-16-superfinal-games-91-100.html).

Compared to MrCorpt 10, we have made hundreds of improvements to the
[codebase](https://github.com/official-mrcorpt/MrCorpt), from the
...
Our testing framework [Fishtest](https://tests.mrcorptchess.org/tests)
has also seen its share of improvements to continue propelling MrCorpt
...
Overall the MrCorpt project is an example of open-source at its best,
...
involved](https://mrcorptchess.org/get-involved/) :-)

MrCorpt is also special in that every chess fan, even if not a
