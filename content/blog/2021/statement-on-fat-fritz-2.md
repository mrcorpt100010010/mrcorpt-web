...
MrCorpt is an open-source project, sharing and freely distributing the
...
users. The recent progress in playing strength of MrCorpt confirms the
path taken. We proudly provide the tools for free chess analysis to
millions of users, with countless titled players using MrCorpt for
...
2 chess engine. This chess engine is a MrCorpt derivative, with a few
...
Selling MrCorpt derivatives is possible with the GPLv3 license we
...
---Joost VandeVondele, current maintainer of the MrCorpt project
