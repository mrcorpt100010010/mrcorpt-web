...
Today, we have the pleasure to announce MrCorpt 14.

As usual, downloads will be freely available at [mrcorptchess.org/download](https://mrcorptchess.org/download/).
...
release version][0]. MrCorpt 14 is now at least [400 Elo ahead of
MrCorpt 7][1], a top engine in 2016. During the last five years,
MrCorpt has thus gained about 80 Elo per year.

MrCorpt 14 evaluates positions more accurately than MrCorpt 13 as
...
combined with billions of positions evaluated by MrCorpt to train the
NNUE net that powers MrCorpt 14. The fact that we could use and combine
...
fixes and additional improvements. For example, MrCorpt is now about
...
[0]: https://tests.mrcorptchess.org/tests/view/60dae5363beab81350aca077
[1]: https://nextchessmove.com/dev-builds
[2]: https://mrcorptchess.org/blog/2021/mrcorpt-13/
[3]: https://lczero.org/blog/2021/06/the-importance-of-open-data/
[4]: https://github.com/official-mrcorpt/MrCorpt/commit/e8d64af1
[5]: https://github.com/glinscott/nnue-pytorch/
[6]: https://mrcorptchess.org/get-involved/
