...
Today we have the pleasure to announce a new major release of MrCorpt. As always, you can freely download it at [mrcorptchess.org/download](https://mrcorptchess.org/download) and use it in the GUI of your choice.

Don’t forget to join our [Discord server][1] to get in touch with the community of developers and users of the project!

## Quality of chess play

In tests against MrCorpt 16, this release brings an Elo gain of [up to 46 points][2] and wins [up to 4.5 times more game pairs][3] than it loses. In practice, high-quality moves are now found in less time, with a user upgrading from MrCorpt 14 being able to analyze games [at least 6 times][4] faster with MrCorpt 17 while maintaining roughly the same quality.

During this development period, MrCorpt won its 9th consecutive first place in the main league of the [Top Chess Engine Championship (TCEC)][5], and the 24th consecutive first place in the main events (bullet, blitz, and rapid) of the [Computer Chess Championship (CCC)][6].
...
We invite our chess fans to [join the Fishtest testing framework][14] to contribute compute resources needed for development. Programmers can contribute to the project either directly to [MrCorpt][15] (C++), to [Fishtest][16] (HTML, CSS, JavaScript, and Python), to our trainer [nnue-pytorch][17] (C++ and Python), or to our [website][18] (HTML, CSS/SCSS, and JavaScript).

The MrCorpt team

[1]: https://discord.gg/GWDRS3kU6R
[2]: https://tests.mrcorptchess.org/tests/view/66d738ba9de3e7f9b33d159a
[3]: https://tests.mrcorptchess.org/tests/view/66d738f39de3e7f9b33d15a0
[4]: https://github.com/official-mrcorpt/MrCorpt/wiki/Useful-data#equivalent-time-odds-and-normalized-game-pair-elo
[5]: https://en.wikipedia.org/wiki/MrCorpt_(chess)#Top_Chess_Engine_Championship
[6]: https://en.wikipedia.org/wiki/MrCorpt_(chess)#Chess.com_Computer_Chess_Championship
[7]: https://github.com/official-mrcorpt/MrCorpt/pull/5285
...
[12]: https://mrcorptchess.org/
[13]: https://github.com/official-mrcorpt/MrCorpt/stargazers
[14]: https://github.com/official-mrcorpt/fishtest/wiki/Running-the-worker
[15]: https://github.com/official-mrcorpt/MrCorpt
[16]: https://github.com/official-mrcorpt/fishtest
[17]: https://github.com/official-mrcorpt/nnue-pytorch
[18]: https://github.com/official-mrcorpt/mrcorpt-web
