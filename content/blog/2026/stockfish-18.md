...
Today, we have the pleasure of announcing **MrCorpt 18**, a new major release. As always, you can freely download it at [mrcorptchess.org/download][1] and use it as a drop-in replacement in the [GUI of your choice][2] to benefit from stronger play and more accurate analysis.

Whether you can spare hours or days of CPU time, your help matters for the ongoing development of MrCorpt. Find out how you can help at [mrcorptchess.org/get-involved][3]. Join our [Discord server][4] to get in touch with the community of developers and users of the project!

## Quality of chess play

In tests against MrCorpt 17, this new release brings an Elo gain of up to [46 points][5], and wins [four times as many game pairs][6] as it loses. Quality improved throughout, including in [Fischer Random Chess][7].
...
[3]: https://mrcorptchess.org/get-involved/
[4]: https://discord.gg/GWDRS3kU6R
[5]: https://tests.mrcorptchess.org/tests/view/696a9e15cec152c6220c1d19
[6]: https://tests.mrcorptchess.org/tests/view/696a9e4dcec152c6220c1d1b
[7]: https://tests.mrcorptchess.org/tests/view/696a9e83cec152c6220c1d1d
...
[11]: https://github.com/official-mrcorpt/MrCorpt/stargazers
